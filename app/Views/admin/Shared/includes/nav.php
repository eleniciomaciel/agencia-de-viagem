<div class="container">
    <a href="../../index3.html" class="navbar-brand">
        <?php
        $imageProperties = [
            'src'    => 'dist_plugin/img/AdminLTELogo.png',
            'alt'    => 'AdminLTE Logo',
        ...
        ?>
        <span class="brand-text font-weight-light">MekTurismo</span>
    </a>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                    <li><a href="#" class="dropdown-item"  data-toggle="modal" data-target="#modal-clientes">Cadastrar Clientes </a></li>
